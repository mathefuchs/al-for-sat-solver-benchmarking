...
The plotted lines represent the best performing configurations per ranking approach (Fig.~\ref{fig:annitraincolorranking}), per selection approach (Fig.~\ref{fig:annitraincolorselection}), and per stopping criterion (Fig.~\ref{fig:annitraincolorstopping}).
