...
%\renewcommand{\thealgocf}{}
  ...
  $\mathcal{M} \leftarrow \operatorname{initModel}(\mathcal{A}, \mathcal{I}, r, \hat{a})$ \tcp*{cf. Section~\ref{sec:main:model}}
...
\begin{algorithm}[htb]
  ...
  \For{$\hat{a} \in \mathcal{A}$}{
    ...
    \For{$a \in \mathcal{A}$}{
    	...
    	%JB: why is "\hat a" subscript of s rather than argument?
    	%JB: "par_2" needs to be defined in text
    }
