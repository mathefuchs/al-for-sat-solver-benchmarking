...
\emph{Most Freq.} uses the instances most frequently sampled by active learning.
In particular, we consider the average sampling frequencies over all solvers and Pareto-optimal active-learning approaches.
