...
Thus, it is highly desirable to reduce benchmarking time and discard unpromising ideas early, thereby testing more approaches or spending more time on the promising ones.
...
All our source code\footnote{\url{https://github.com/mathefuchs/al-for-sat-solver-benchmarking}} and data\footnote{\url{https://github.com/mathefuchs/al-for-sat-solver-benchmarking-data}} are available on GitHub.
...
In this work, we have addressed to the \emph{New-Solver Problem}:
