...
\authorrunning{Authors anonymized for review} % according to sample paper of template: first names are abbreviated; if there are more than two authors, 'et al.' is used.
...
All our source code\footnote{temporary reference, anonymized version for review: \url{https://github.com/dgnr7vexskfoc3a67jdtf96kd9opz/al-for-sat-solver-benchmarking}} and and data\footnote{temporary reference, anonymized version for review: \url{https://github.com/dgnr7vexskfoc3a67jdtf96kd9opz/al-for-sat-solver-benchmarking-data}} are available on GitHub.
