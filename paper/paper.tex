...
\begin{table}[tbp]
  ...
  \begin{tabular}{
    ...
    % \tablefootnote{While using a model-based selection strategy to select the next configuration to evaluate, the instance selection is done randomly.}
...
We discuss possible criteria for selecting instances in Section~\ref{sec:main:selection}.
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    %JB: we vote for the label of each instance separately, right? (rather than globally ensembling the overall solver score of the last x iteration)
    \item
    ...
    %TF: Not necessarily
    %JB: but how can the scores of two existing solvers change? and we only have partially observed scores for the new solver
...
% One of the main observations is that uncertainty sampling (blue points) consistently outperformed random sampling (red points) for almost any value of $\delta$ within Eq.~\ref{eq:opt}.
% Moreover, our ranking stopping criterion (dot-shaped points) is particularly suited to achieve a good ranking accuracy fast.
% In comparison, our Wilcoxon stopping criterion is suited better for high-accuracy predictions.
...
%   	Ranking approaches are either predicted runtime-label ranking (Pred.) or observed PAR-2 ranking (PAR-2).
%   	Selection approaches are either uncertainty sampling (Uncert.) or information-gain sampling (IG).
%   	Stopping criteria are either ranking (Rank) or Wilcoxon (Wilcoxon).
...
%     \hline
%     0.00 & PAR-2 & Uncert. & Rank & 0.021 & 0.025 & 0.593 & 0.979 \\
%     0.05 & Pred. & Uncert. & Rank & 0.024 & 0.158 & 0.765 & 0.966 \\
%     0.10 & Pred. & Uncert. & Rank & 0.025 & 0.128 & 0.779 & 0.955 \\
%     0.15 & Pred. & IG & Rank & 0.028 & 0.112 & 0.802 & 0.946 \\
%     $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ \\
%     0.50 & Pred. & IG & Rank & 0.028 & 0.112 & 0.802 & 0.887 \\
%     0.55 & Pred. & Uncert. & Rank & 0.053 & 0.142 & 0.824 & 0.880 \\
%     0.60 & Pred. & Uncert. & Rank & 0.146 & 0.082 & 0.897 & 0.880 \\
%     $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ \\
%     0.75 & Pred. & Uncert. & Rank & 0.146 & 0.082 & 0.897 & 0.886 \\
%     0.80 & Pred. & Uncert. & Rank & 0.219 & 0.128 & 0.917 & 0.890 \\
%     \hline
%     0.85 & Pred. & Uncert. & Rank & 0.272 & 0.171 & 0.927 & 0.897 \\
%     \hline
